...
public class EchoHandler extends TextWebSocketHandler {
	...
	protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
		File file = new File("C:\\Users\\13\\Desktop\\" + getids.getId("myid")+ getids.getId("yourid") + ".txt");
		File file2 = new File("C:\\Users\\13\\Desktop\\" + getids.getId("yourid")+ getids.getId("myid") + ".txt");
