...
<script>
	...
	//이미지 업로드 컨트롤러 연결
		...
		CKEDITOR.config.width =  700;// 넓이 CKEDITOR.config.height = 500; // 높이 // 퍼센트로 가능합니다.
	...
	<article>
		<div class="container" role="main">
			...
			<form:form name="form" id="form" role="form" modelAttribute="boardVO"
				method="post"
				action="${pageContext.request.contextPath}/board/saveBoardTwo">
				...
				<%-- <form id="contents" name="contents">
					 	<div id="contents" class="contents">${boardContent.contents}</div>
					 </form> --%>
