...
<body>
	<div class="base">
		...
		<div class="main">
			<button style="cursor: pointer;"><img alt="매치 메이커" src="resources/img/matchmaker.png">
				<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />메치 메이커<br />(페이지 이동)
			</button>
			<button style="cursor: pointer;"><img alt="반갑다 친구야" src="resources/img/nicemeetyou.png">
				<br/>반갑다 친구야<br />(페이지 이동)
			</button>
		</div>
		<footer>
			<table>
