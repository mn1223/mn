		...
		<div class="container" role="main">
			...
			<form:form name="form" id="form" role="form" modelAttribute="boardVO" method="post"
				...
				<div class="mb-3">
					...
					<label for="title">제목</label> <form:input path="title"
				...
				<div class="mb-3">
					...
					<label for="reg_id">작성자</label> <form:input path="reg_id"
				...
				<div class="mb-3">
					...
					<label for="tag">TAG</label> <form:input path="tag"
				...
				<div class="mb-3">
					...
					<label for="cate_cd">CATE_CD</label> <form:input path="cate_cd"
						class="form-control" id="cate_cd" value="1"/>
