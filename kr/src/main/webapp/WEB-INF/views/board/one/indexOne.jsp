...
<script>
	...
	$(document).on('click', "#btnWriteForm", function(e) {
		...
		location.href = "${pageContext.request.contextPath}/board/boardFormOne";
	});
	
	//목록버튼 클릭시
	$(document).on('click', "#btnlistForm", function(){
		
		location.href = "${pageContext.request.contextPath}/board/getBoardListOne";
	});
	
	//제목을 클릭했을때 상세보기로 이동
	function fn_contentView(bno){
		var url = "${pageContext.request.contextPath}/board/getBoardContentOne";
		url = url + "?bno="+bno		
		location.href = url;
	}
	...
	function fn_prev(page, range, rangeSize) {
		...
		var url = "${pageContext.request.contextPath}/board/getBoardListOne";
		url = url + "?page=" + page;
		url = url + "&range=" + range;
		location.href = url;
	}
