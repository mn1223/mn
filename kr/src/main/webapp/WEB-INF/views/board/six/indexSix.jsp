...
<script>	
	...
	$(document).on('click', "#btnWriteForm", function(e) {
		...
		location.href = "${pageContext.request.contextPath}/board/boardFormSix";
	});
	...
	function fn_contentView(bno){
		var url = "${pageContext.request.contextPath}/board/getBoardContentSix";
		url = url + "?bno="+bno		
		location.href = url;
	}
	...
	function fn_prev(page, range, rangeSize) {
		...
		var url = "${pageContext.request.contextPath}/board/getBoardListSix";
		url = url + "?page=" + page;
		url = url + "&range=" + range;
		location.href = url;
	}
